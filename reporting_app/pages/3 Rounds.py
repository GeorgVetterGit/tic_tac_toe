...
with col2:
    ...
    st.image('results/RR_rounds.png')
with col3:
...
with col2:
    st.image('results/QR_rounds.png')
with col3:
    st.image('results/QQ_rounds.png')
with col4:
    st.text('')
...
with col2:
    st.image('results/RM_rounds.png')
with col3:
    st.image('results/QM_rounds.png')
with col4:
    st.image('results/MM_rounds.png')