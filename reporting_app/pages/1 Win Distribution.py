...
with col2:
    ...
    st.image('tic_tac_toe/results/RR_dist.png')
with col3:
...
with col2:
    st.image('tic_tac_toe/results/QR_dist.png')
with col3:
    st.image('tic_tac_toe/results/QQ_dist.png')
with col4:
    st.text('')
...
with col2:
    st.image('tic_tac_toe/results/RM_dist.png')
with col3:
    st.image('tic_tac_toe/results/QM_dist.png')
with col4:
    st.image('tic_tac_toe/results/MM_dist.png')