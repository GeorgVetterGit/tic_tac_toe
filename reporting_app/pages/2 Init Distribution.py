...
st.subheader("Winner initial turn distribution")
...
with col2:
    ...
    st.image('tic_tac_toe/results/RR_init.png')
with col3:
...
with col2:
    st.image('tic_tac_toe/results/QR_init.png')
with col3:
    st.image('tic_tac_toe/results/QQ_init.png')
with col4:
    st.text('')
...
with col2:
    st.image('tic_tac_toe/results/RM_init.png')
with col3:
    st.image('tic_tac_toe/results/QM_init.png')
with col4:
    st.image('tic_tac_toe/results/MM_init.png')