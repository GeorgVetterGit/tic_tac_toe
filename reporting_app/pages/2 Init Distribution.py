...
with col2:
    st.image('results/QR_init.png')
with col3:
    st.image('results/QQ_init.png')
with col4:
    st.text('')
...
with col2:
    st.image('results/RM_init.png')
with col3:
    st.image('results/QM_init.png')
with col4:
    st.image('results/MM_init.png')